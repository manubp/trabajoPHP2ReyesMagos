...
//Select donde nos mostrara los datos de los jueguetes ordenados desde el precio mayor al menor.
$consultaJuguetes = "SELECT * from juguetes ORDER BY precioJuguete DESC";
$resultadoJuguetes = mysqli_query($conexion, $consultaJuguetes);
                ...
                <!-- Creación de la tabla -->
                    <table class="table table-dark table-bordered">
                        <tr class="table-primary">
                            ...
                            <th id="info">Precio</th>
                            <th id="info">Rey Mago</th>

                        </tr>
                        <!-- Mientras haya elementos en la tabla segurá mostrandolos -->
                        <?php while ($fila = mysqli_fetch_array($resultadoJuguetes)) { ?>
                            <tr>
                               <!-- Nos mostrara en la tabla el nombre del juguete -->
                                <td><?php echo($fila["nombreJuguete"]); ?></td>
                              <!-- Nos mostrara en la tabla el precio del juguete -->
                                <td><?php echo($fila["precioJuguete"]."€"); ?></td>
                                <td>
                                    <?php
                                    //Si el rey mago tiene como id el 1 nos mostrara el nombre de Melchor.
                                        if ($fila["idReyMagoFK"] == 1)
                                        {
                                            echo("Melchor");
                                    //Si el rey mago tiene como id el 2 nos mostrara el nombre de Melchor.
                                        }  if ($fila["idReyMagoFK"] == 2) {
                                            echo("Gaspar");
                                    //Si el rey mago tiene como id el 3 nos mostrara el nombre de Baltasar
                                        } if ($fila["idReyMagoFK"] == 3) {
                                          echo("Baltasar");
                                      }
                                    ?>
                                </td>
