  ...
  <div class="container">
            ...
            <div class="col-12">
                <div class="table-responsive">
                  ...
                  <h1>Carta de deseos</h1>
              <form action="busqueda.php" method="POST">
                <label>Lista de niño:</label>
                <select name="id">
                ...
                <input type="submit" value="Ver juguetes">
            </form>
                        <tr class="table-primary">
                            <th id="info">Nombre del juguete</th>
                            <th id="info">Precio del juguete</th>
                        </tr>
                </thead>
                <tbody>
                <?php
                  if(isset($_POST["id"])){
                   $id = $_POST["id"];
                    ...
                    $selectRegalos = mysqli_query($conexion, "SELECT jug.nombreJuguete, jug.precioJuguete FROM juguetes jug, pedidos ped 
                                  WHERE jug.idJuguete = ped.idJugueteFK AND ped.idNinoFK =  $id");
    
                                    while ($fila = mysqli_fetch_assoc($selectRegalos)) {
                                     echo "<tr>";
